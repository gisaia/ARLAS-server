...
public class OGCExceptionMessage {
    private final OGCExceptionCode exceptionCode;
    private List<String> exceptionTexts;
    private String locator;

    public OGCExceptionMessage(OGCExceptionCode exceptionCode) {
        this.exceptionCode = exceptionCode;
    }

    public OGCExceptionMessage(OGCExceptionCode exceptionCode, String exceptionText) {
        this(exceptionCode);
        addExceptionText(exceptionText);
    }

    public OGCExceptionMessage(OGCExceptionCode exceptionCode, String exceptionText, String locator) {
        this(exceptionCode, exceptionText);
        this.locator = locator;
    }

    public OGCExceptionMessage(OGCExceptionCode exceptionCode, List<String> exceptionTexts) {
        this(exceptionCode);
        this.exceptionTexts = exceptionTexts;
    }

    public OGCExceptionMessage(OGCExceptionCode exceptionCode, List<String> exceptionTexts, String locator) {
