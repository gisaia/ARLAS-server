...
public class Documentation {
    ...
    public static final String GMM_MAX_SPREAD = "The maximum spread of the gaussians generated by the Gaussian Mixture Model. It can be used to restrict the dispersion of gaussians, but might increase the computation time.";
    public static final String GMM_MAX_COMPONENTS = "The maximum number of gaussians that the aggregation can return. If not specified it is 6.";
