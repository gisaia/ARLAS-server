...
public class Documentation {
    ...
    public static final String GMM_MAX_SPREAD = "The maximum spread of the gaussians generated by the Gaussian Mixture Model. It can be used to restrict the dispersion of gaussians, but might increase the computation time. If no value is given, and the aggregation is performed on angular data ('abscissaUnit' is 'radian' or 'degree'), then a default value of 60° is applied.";
    public static final String GMM_MAX_COMPONENTS = "The maximum number of gaussians that the aggregation can return.";
    public static final String GMM_ABSCISSA_UNIT = "The type of data that will be aggregated. Should be 'degree' or 'radian' if aggregating an angular data, and nothing otherwise.";
}
