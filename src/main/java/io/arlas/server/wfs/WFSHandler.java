...
public class WFSHandler {
    ...
    public WFSHandler(ArlasServerConfiguration configuration) throws ArlasConfigurationException, ParserConfigurationException {
        arlasServerConfiguration =configuration;
        getCapabilitiesHandler = new GetCapabilitiesHandler(configuration,this);
        describeFeatureTypeHandler = new DescribeFeatureTypeHandler();
        listStoredQueriesHandler = new ListStoredQueriesHandler(this);
        getFeatureHandler = new GetFeatureHandler();
    };
}
