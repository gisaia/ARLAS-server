...
public class CheckParams {
    ...
    public static Boolean isPolygon(Geometry geometry){
        ...
        if(geometryType.equals(POLYGON_TYPE)) return  true; else return false;
    }
    ...
    //Verify that the sort parameter respects the specified syntax. Returns the field and the ASC/DESC
    ...
    //verify if the aggregation interval suits the date type aggregation. Retruns the interval (size+unit) if it is ok.
